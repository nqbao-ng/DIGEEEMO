...
### CMUMOSEID
```bash
python -u run.py --dataset CMUMOSEIDataset7 --gpu 0 --port 1534 --lr 1e-06 --l2 1e-5 --batch_size 32 --epochs 80 --hidden_dim 256 --win 5 5 --heter_n_layers 2 2 2 \
--dropout_1 0.2 --dropout_2 0.4 --loss_type wo_distil --gammas 1.0 0.2 0.1 --num_heads 8 --temp 5.0 --results_root results \
--seeds 2018 2020 2022 2024 2026 2028 2030 2016 2014 2032
```
